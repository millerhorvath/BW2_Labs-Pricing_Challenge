...
# Keeping only the data about P9
correlated = correlated[correlated$PROD_ID == "P9",]
...
# listvar = c()
listvar = c("C4_PRICE_1", "C4_PRICE_2", "MEAN_PRICE", "DATE")
# listvar = c("MEAN_PRICE")
...
prp(dtree, type=4,fallen.leaves=FALSE, main="Regression Tree for P9", faclen=0)
...
# Write CSV in R
write.table(predicted_vector, file = "predictions/regression_tree_P9.csv",row.names=FALSE, na="",col.names=TRUE, sep=";")
