...
# Keeping only the data about P7
correlated = correlated[correlated$PROD_ID == "P7",]
...
# listvar = c()
# listvar = c("C6_PRICE_1", "C6_PRICE_2")
...
prp(dtree, type=4,fallen.leaves=FALSE, main="Regression Tree for P7", faclen=0)
...
# Write CSV in R
write.table(predicted_vector, file = "predictions/regression_tree_P7.csv",row.names=FALSE, na="",col.names=TRUE, sep=";")
