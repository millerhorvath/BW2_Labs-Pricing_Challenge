...
# Keeping only the data about P6
correlated = correlated[correlated$PROD_ID == "P6",]
...
# correlated = correlated[correlated$DATE >= "2015-01-07",]
...
# listvar = c()
listvar = c("C5_PRICE_1", "C5_PRICE_2", "C4_PRICE_1", "C4_PRICE_2", "MEDIAN_PRICE")
...
prp(dtree, type=4,fallen.leaves=FALSE, main="Regression Tree for P6", faclen=0)
...
# Write CSV in R
write.table(predicted_vector, file = "predictions/regression_tree_P6.csv",row.names=FALSE, na="",col.names=TRUE, sep=";")
