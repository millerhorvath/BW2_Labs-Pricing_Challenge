...
# Keeping only the data about P8
correlated = correlated[correlated$PROD_ID == "P8",]
...
# correlated = correlated[correlated$DATE >= "2015-05-05",]
...
prp(dtree, type=4,fallen.leaves=FALSE, main="Regression Tree for P8", faclen=0)
...
# Write CSV in R
write.table(predicted_vector, file = "predictions/regression_tree_P8.csv",row.names=FALSE, na="",col.names=TRUE, sep=";")
