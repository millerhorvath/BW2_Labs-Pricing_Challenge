...
# Keeping only the data about P1
correlated = correlated[correlated$PROD_ID == "P1",]
...
correlated = correlated[correlated$DATE >= "2015-03-17",]
...
# listvar = c()
listvar = c("C4_PRICE_1", "C4_PRICE_2", "C6_PRICE_1", "C6_PRICE_2", "C3_PRICE_1", "C3_PRICE_2")
...
prp(dtree, type=4,fallen.leaves=FALSE, main="Regression Tree for P1", faclen=0)
...
# Write CSV in R
write.table(predicted_vector, file = "predictions/regression_tree_P1.csv",row.names=FALSE, na="",col.names=TRUE, sep=";")
